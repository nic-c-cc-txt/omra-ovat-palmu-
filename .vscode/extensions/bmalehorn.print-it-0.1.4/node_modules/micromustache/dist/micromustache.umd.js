/* micromustache v7.1.0 */
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
  typeof define === 'function' && define.amd ? define(['exports'], factory) :
  (global = global || self, factory(global.micromustache = {}));
      ...
      function Renderer(tokens, options) {
          ...
          this.render = function (scope) {
              ...
              for (var i = 0; i < length; i++) {
                  values[i] = get(scope, _this.toPathCache[i], _this.options.propsExist);
              }
  ...
  function tokenize(template, options) {
      ...
      if (!Array.isArray(options)) {
          throw Error("Tags should be an array. Got " + options);
      }
      if (options.length !== 2) {
      ...
      while (currentIndex < template.length) {
          ...
          var varNameLength = closeIndex - varNameStartIndex;
          if (varNameLength > maxVarNameLength) {
              throw new SyntaxError('Variable name cannot be longer than ' +
                  maxVarNameLength +
                  ' but at position ' +
                  openIndex +
                  ' it is "' +
          ...
          if (varName.includes(openSym)) {
              throw new SyntaxError('Variable names cannot have "' +
                  openSym +
                  '". But at position ' +
                  openIndex +
                  ' got "' +
  ...
  function compile(template, options) {
      ...
      var tokens = tokenize(template, options.tags);
